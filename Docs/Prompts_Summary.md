...
| 13 | 2026-07-19 | Update DEPLOYMENT.md to reflect real Neon setup: production maps to Neon `main` branch (kept, not renamed) in the Vercel-managed project neon-bronze-pocket; staging/demo branches added | `_pending_` | Committed locally |
